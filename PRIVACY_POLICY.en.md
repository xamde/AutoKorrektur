...
AutoKorrektur is an open-source project (GNU AGPLv3) in the service of the mobility transition and liveable cities. The controller responsible for data processing is Konrad Völkel, Düsseldorf; the full postal address is in the [Impressum](https://autokorrektur.org/impressum) (German). For privacy questions, reach us by e-mail at kontakt [at] autokorrektur [dot] org or through the project's [GitHub repository](https://github.com/konradvoelkel/AutoKorrektur). You have the rights under Articles 15–21 GDPR and the right to lodge a complaint with a supervisory authority.

...
open class YoloException(message: String, cause: Throwable? = null) : RuntimeException(message, cause)
...
class ShapeMismatchException(message: String, cause: Throwable? = null) : YoloException(message, cause)
